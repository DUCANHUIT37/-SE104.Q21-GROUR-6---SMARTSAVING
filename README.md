...
| Tính năng | Mô tả |
|-----------|-------|
| 🔐 **Xác thực bảo mật** | Phân quyền 3 Role (Admin, Teller, Customer) với JWT & BCrypt |
| 📒 **Quản lý sổ tiết kiệm** | Tạo sổ với validate kiểm tra hạn mức tiền gửi tối thiểu (QĐ1) |
| 📊 **Dashboard tổng quan** | Theo dõi tổng số dư, lãi suất, kỳ hạn và ngày đáo hạn |
| 💸 **Giao dịch linh hoạt** | Gửi/Rút tiền (Kiểm tra hạn mức), tự động tính lãi phạt rút trước hạn |
| 🕒 **Lịch sử giao dịch** | Xem chi tiết toàn bộ lịch sử nạp/rút tiền |
| ⚙️ **Cấu hình hệ thống** | Admin điều chỉnh lãi suất, tham số (Tiền gửi, Thời gian) |
| 📈 **Báo cáo Kế toán** | Lập Báo cáo doanh số ngày và Đóng/Mở sổ tháng chính xác |
| 📱 **Responsive UI** | Giao diện mượt mà, phân trang (pagination) và tối ưu thao tác |
...
| `PUT` | `/loaitietkiem/{id}/toggle` | Kích hoạt/Vô hiệu hóa (Soft Delete) kỳ hạn |
| `PUT` | `/thamso/{khoa}` | Cập nhật tham số hạn mức hệ thống |
| `GET` | `/baocao/ngay` | Xem báo cáo doanh số giao dịch ngày |
| `GET` | `/baocao/thang` | Xem báo cáo đóng mở sổ theo tháng |
