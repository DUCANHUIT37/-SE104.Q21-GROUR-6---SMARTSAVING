...
CREATE TABLE QuyDinh (
                         ...
                         CONSTRAINT fk_quydinh_capnhatboi FOREIGN KEY (cap_nhat_boi) REFERENCES NguoiDung(id) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE LichSuQuyDinh (
                               ...
                               thoi_gian         DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
                               PRIMARY KEY (id),
                               CONSTRAINT fk_lsqd_quydinh FOREIGN KEY (quy_dinh_id) REFERENCES QuyDinh(id) ON UPDATE CASCADE ON DELETE RESTRICT,
                               CONSTRAINT fk_lsqd_capnhatboi FOREIGN KEY (cap_nhat_boi) REFERENCES NguoiDung(id) ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
